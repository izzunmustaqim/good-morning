package com.applab.goodmorning.ContactUs.activity;
...
public class ContactUsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTxtToolbarTitle.setText(getString(R.string.title_activity_contact_us));
        ...
        mDrawerFragment.setSelectedPosition(7);
        ...
        mPager.setAdapter(new ContactUsPagerAdapter(getSupportFragmentManager(), this));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        Utilities.setAddCartOnClickListener(ContactUsActivity.this, mActionShop);
        return true;
    }
