...
public class MaterialCalendarView extends ViewGroup {
        ...
        try {
            ...
            if (leftMask == null) {
                if (Build.VERSION.SDK_INT >= 21) {
                    leftMask = getResources().getDrawable(R.drawable.mcv_action_previous, mContext.getTheme());
                } else {
            ...
            if (rightMask == null) {
                if (Build.VERSION.SDK_INT >= 21) {
                    rightMask = getResources().getDrawable(R.drawable.mcv_action_next, mContext.getTheme());
                } else {
    ...
    private void setupChildren() {
        ...
        topbar.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.color_top_bar));
